...
<Columns cols={2}>
  <Card title="Linux PrivEsc" icon="linux" href="/docs/attacks/privilege-escalation/linux">
    SUID, sudo misconfigs, cron jobs, capabilities, and kernel exploits.
  </Card>
  <Card title="Windows PrivEsc" icon="windows" href="/docs/attacks/privilege-escalation/windows">
